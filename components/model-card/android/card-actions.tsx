  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.likes}>
        <Ionicons name="heart-outline" size={20} color={isDark ? '#FF6B6B' : '#F44336'} />
        <Text
          style={[
            styles.likesText,
            {
      ...
      <TouchableOpacity
        style={[
          ...
          {
            backgroundColor: isDark ? 'rgba(66, 133, 244, 0.12)' : 'rgba(25, 118, 210, 0.08)',
          },
        ]}
        activeOpacity={0.7}
        ...
        onPress={onBookmark}
      >
        <Ionicons name="bookmark-outline" size={16} color={isDark ? '#4285F4' : '#1976D2'} />
        <Text style={[styles.bookmarkText, { color: isDark ? '#4285F4' : '#1976D2' }]}>收藏</Text>
      </TouchableOpacity>
    </View>
  );
}
