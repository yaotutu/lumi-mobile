  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.likes}>
        <Ionicons name="heart-outline" size={20} color={isDark ? '#FF453A' : '#FF3B30'} />
        <Text
          style={[
            styles.likesText,
            {
      ...
      <TouchableOpacity
        ...
        onPress={onBookmark}
      >
        <Ionicons name="bookmark-outline" size={16} color={isDark ? '#FFFFFF' : '#000000'} />
        <Text style={[styles.bookmarkText, { color: isDark ? '#FFFFFF' : '#000000' }]}>收藏</Text>
      </TouchableOpacity>
    </View>
  );
}
