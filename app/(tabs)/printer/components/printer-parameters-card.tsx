  ...
  return (
    ...
    >
      ...
      <View style={styles.temperatureTable}>
        ...
        >
          <View style={styles.tableHeaderCell}>{/* 空白单元格（用于图标和标签列） */}</View>
        ...
        <View style={styles.tableRow}>
          ...
          <View style={styles.tableLabelCell}>
            ...
            <ThemedText style={[styles.tableLabel, { color: secondaryTextColor }]}>喷头</ThemedText>
          </View>
        ...
        <View style={styles.tableRow}>
          ...
          <View style={styles.tableLabelCell}>
            ...
            <ThemedText style={[styles.tableLabel, { color: secondaryTextColor }]}>热床</ThemedText>
          </View>
