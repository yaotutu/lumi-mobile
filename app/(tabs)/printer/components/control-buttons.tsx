...
export function ControlButtons({
  ...
  const handleStop = async () => {
    ...
    // 二次确认
    Alert.alert('确认停止打印', '停止后无法恢复，确定要停止当前打印任务吗？', [
      {
        text: '取消',
        style: 'cancel',
      },
  ...
  return (
    <View style={styles.container}>
      ...
      {status === 'printing' ? (
        ...
        >
          <Ionicons name="pause" size={20} color={isDark ? Colors.dark.text : Colors.light.text} />
          <ThemedText
            style={[
      ...
      >
        {isStopping ? (
          ...
          <>
            ...
            <ThemedText style={[styles.secondaryButtonText, { color: '#FF3B30' }]}>停止</ThemedText>
          </>
        )}
      </TouchableOpacity>
    </View>
